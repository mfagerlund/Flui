                    ...
                    RootVisualElement, x => x
                        ...
                        .ScrollView("unnamed0", "", unnamed0 => unnamed0
                            .VisualElement("unnamed1", "row", unnamed1 => unnamed1
                                .Button(_ => Close(), "btn-warning")
                            ).VisualElement("unnamed2", "row", unnamed2 => unnamed2
                                .Button(_=>Primary(), "btn-primary")
                                .Button(_=>Info(), "btn-info", "Info")
                                .Button(_=>Secondary(), "btn-secondary", "Secondary")
                                .Button(_=>Success(), "btn-success", "Success")
                                .Button(_=>Warning(), "btn-warning", "Warning")
                            ).VisualElement("unnamed3", "row", unnamed3 => unnamed3
                                .Button(_=>Primary(), "btn-primary, disabled", "Primary")
                                .Button(_=>Info(), "btn-info, disabled", "Info")
                                .Button(_=>Secondary(), "btn-secondary, disabled", "Secondary")
                                .Button(_=>Success(), "btn-success, disabled", "Success")
                                .Button(_=>Warning(), "btn-warning, disabled", "Warning")
